...
public class OCCUPATION extends TableImpl<Record> {

    private static final long serialVersionUID = 443398139;

    /**
     * The reference instance of <code>school.occupation</code>
     */
    ...
    /**
     * The column <code>school.occupation.created_date</code>.
     */
    ...
    /**
     * The column <code>school.occupation.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.occupation.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.occupation.name</code>.
     */
    ...
    /**
     * Create a <code>school.occupation</code> table reference
     */
    public OCCUPATION() {
    ...
    /**
     * Create an aliased <code>school.occupation</code> table reference
     */
    public OCCUPATION(String alias) {
        this(alias, OCCUPATION);
    }

    private OCCUPATION(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private OCCUPATION(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public Identity<Record, Long> getIdentity() {
        return Keys.IDENTITY_OCCUPATION;
    }
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Keys.KEY_OCCUPATION_PRIMARY;
    }
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_OCCUPATION_PRIMARY);
    }
