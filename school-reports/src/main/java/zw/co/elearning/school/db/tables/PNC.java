...
public class PNC extends TableImpl<Record> {

    private static final long serialVersionUID = -1142016253;

    /**
     * The reference instance of <code>school.pnc</code>
     */
    ...
    /**
     * The column <code>school.pnc.created_date</code>.
     */
    ...
    /**
     * The column <code>school.pnc.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.pnc.last_modified_date</code>.
     */
    ...
    /**
     * Create an aliased <code>school.pnc</code> table reference
     */
    public PNC(String alias) {
        this(alias, PNC);
    }

    private PNC(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PNC(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_PNC_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FKNASGH2DNK8NCECP7028HRK0X5);
    }
     ...
     */
    @Override
    public PNC as(String alias) {
        return new PNC(alias, this);
    }
     ...
     */
    @Override
    public PNC rename(String name) {
        return new PNC(name, null);
    }
}
