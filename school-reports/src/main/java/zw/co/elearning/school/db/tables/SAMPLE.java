...
public class SAMPLE extends TableImpl<Record> {

    private static final long serialVersionUID = -1032176405;

    /**
     * The reference instance of <code>school.sample</code>
     */
    ...
    /**
     * The column <code>school.sample.created_date</code>.
     */
    ...
    /**
     * The column <code>school.sample.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.sample.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.sample.code</code>.
     */
    ...
    /**
     * The column <code>school.sample.name</code>.
     */
    ...
    /**
     * The column <code>school.sample.standard_id</code>.
     */
    ...
    /**
     * Create a <code>school.sample</code> table reference
     */
    public SAMPLE() {
        this("sample", null);
    }
    ...
    /**
     * Create an aliased <code>school.sample</code> table reference
     */
    public SAMPLE(String alias) {
        this(alias, SAMPLE);
    }

    private SAMPLE(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private SAMPLE(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Keys.KEY_SAMPLE_PRIMARY;
    }
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_SAMPLE_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FKQFCY6EA02P3NGTMU7DUV5LX6V);
    }
