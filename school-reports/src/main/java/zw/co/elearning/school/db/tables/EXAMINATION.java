...
public class EXAMINATION extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -959698117;

    /**
     * The reference instance of <code>school.examination</code>
     */
    ...
    /**
     * The column <code>school.examination.created_date</code>.
     */
    ...
    /**
     * The column <code>school.examination.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.examination.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.examination.code</code>.
     */
    ...
    /**
     * The column <code>school.examination.name</code>.
     */
    ...
    /**
     * The column <code>school.examination.standard_id</code>.
     */
    ...
    /**
     * Create a <code>school.examination</code> table reference
     */
    public EXAMINATION() {
    ...
    /**
     * Create an aliased <code>school.examination</code> table reference
     */
    public EXAMINATION(String alias) {
        this(alias, EXAMINATION);
    }

    private EXAMINATION(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EXAMINATION(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Keys.KEY_EXAMINATION_PRIMARY;
    }
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_EXAMINATION_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FK519UOHR8CWRTF1MIR3CRGPVWX);
    }
