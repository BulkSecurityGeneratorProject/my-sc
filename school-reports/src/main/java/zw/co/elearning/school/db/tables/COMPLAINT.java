...
public class COMPLAINT extends TableImpl<Record> {

    private static final long serialVersionUID = -48056467;

    /**
     * The reference instance of <code>school.complaint</code>
     */
    ...
    /**
     * The column <code>school.complaint.created_date</code>.
     */
    ...
    /**
     * The column <code>school.complaint.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.complaint.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.complaint.code</code>.
     */
    ...
    /**
     * The column <code>school.complaint.name</code>.
     */
    ...
    /**
     * The column <code>school.complaint.standard_id</code>.
     */
    ...
    /**
     * Create a <code>school.complaint</code> table reference
     */
    public COMPLAINT() {
        this("complaint", null);
    }
    ...
    /**
     * Create an aliased <code>school.complaint</code> table reference
     */
    public COMPLAINT(String alias) {
        this(alias, COMPLAINT);
    }

    private COMPLAINT(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private COMPLAINT(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_COMPLAINT_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FKRTDPK3I8NEGH6GA0AF49RBTY8);
    }
