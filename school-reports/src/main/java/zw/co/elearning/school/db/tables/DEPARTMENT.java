...
public class DEPARTMENT extends TableImpl<Record> {

    private static final long serialVersionUID = 314010914;

    /**
     * The reference instance of <code>school.department</code>
     */
    ...
    /**
     * The column <code>school.department.created_date</code>.
     */
    ...
    /**
     * The column <code>school.department.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.department.last_modified_date</code>.
     */
    ...
    /**
     * Create an aliased <code>school.department</code> table reference
     */
    public DEPARTMENT(String alias) {
        this(alias, DEPARTMENT);
    }

    private DEPARTMENT(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private DEPARTMENT(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_DEPARTMENT_PRIMARY);
    }
