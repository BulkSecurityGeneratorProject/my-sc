...
public class FACILITY extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -45450005;

    /**
     * The reference instance of <code>school.facility</code>
     */
    ...
    /**
     * The column <code>school.facility.created_date</code>.
     */
    ...
    /**
     * The column <code>school.facility.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.facility.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.facility.name</code>.
     */
    ...
    /**
     * Create a <code>school.facility</code> table reference
     */
    public FACILITY() {
        this("facility", null);
    }
    ...
    /**
     * Create an aliased <code>school.facility</code> table reference
     */
    public FACILITY(String alias) {
        this(alias, FACILITY);
    }

    private FACILITY(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private FACILITY(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_FACILITY_PRIMARY);
    }
