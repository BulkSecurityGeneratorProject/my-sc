...
public class UNIT extends TableImpl<Record> {

    private static final long serialVersionUID = 1729746932;

    /**
     * The reference instance of <code>school.unit</code>
     */
    ...
    /**
     * The column <code>school.unit.created_date</code>.
     */
    ...
    /**
     * The column <code>school.unit.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.unit.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.unit.code</code>.
     */
    ...
    /**
     * The column <code>school.unit.description</code>.
     */
    ...
    /**
     * The column <code>school.unit.name</code>.
     */
    ...
    /**
     * The column <code>school.unit.standard_id</code>.
     */
    ...
    /**
     * Create a <code>school.unit</code> table reference
     */
    public UNIT() {
        this("unit", null);
    }
    ...
    /**
     * Create an aliased <code>school.unit</code> table reference
     */
    public UNIT(String alias) {
        this(alias, UNIT);
    }

    private UNIT(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private UNIT(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_UNIT_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FKCLPEG2VKXRGJNNMY8Q8C1937E);
    }
