...
public class SUPPLIER extends TableImpl<Record> {

    private static final long serialVersionUID = -1191247557;

    /**
     * The reference instance of <code>school.supplier</code>
     */
    ...
    /**
     * The column <code>school.supplier.created_date</code>.
     */
    ...
    /**
     * The column <code>school.supplier.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.supplier.last_modified_date</code>.
     */
    ...
    /**
     * Create an aliased <code>school.supplier</code> table reference
     */
    public SUPPLIER(String alias) {
        this(alias, SUPPLIER);
    }

    private SUPPLIER(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private SUPPLIER(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_SUPPLIER_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FKGV3I6Q0J5FTKFXN53H0Y8N2BA);
    }
