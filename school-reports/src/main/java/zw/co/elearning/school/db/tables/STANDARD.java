...
public class STANDARD extends TableImpl<Record> {

    private static final long serialVersionUID = -951531537;

    /**
     * The reference instance of <code>school.standard</code>
     */
    ...
    /**
     * The column <code>school.standard.created_date</code>.
     */
    ...
    /**
     * The column <code>school.standard.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.standard.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.standard.name</code>.
     */
    ...
    /**
     * Create a <code>school.standard</code> table reference
     */
    public STANDARD() {
        this("standard", null);
    }
    ...
    /**
     * Create an aliased <code>school.standard</code> table reference
     */
    public STANDARD(String alias) {
        this(alias, STANDARD);
    }

    private STANDARD(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private STANDARD(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_STANDARD_PRIMARY);
    }
