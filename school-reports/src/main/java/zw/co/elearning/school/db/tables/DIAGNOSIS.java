...
public class DIAGNOSIS extends TableImpl<Record> {

    private static final long serialVersionUID = 1061581428;

    /**
     * The reference instance of <code>school.diagnosis</code>
     */
    ...
    /**
     * The column <code>school.diagnosis.created_date</code>.
     */
    ...
    /**
     * The column <code>school.diagnosis.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.diagnosis.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.diagnosis.code</code>.
     */
    ...
    /**
     * The column <code>school.diagnosis.name</code>.
     */
    ...
    /**
     * The column <code>school.diagnosis.standard_id</code>.
     */
    ...
    /**
     * Create a <code>school.diagnosis</code> table reference
     */
    public DIAGNOSIS() {
        this("diagnosis", null);
    }
    ...
    /**
     * Create an aliased <code>school.diagnosis</code> table reference
     */
    public DIAGNOSIS(String alias) {
        this(alias, DIAGNOSIS);
    }

    private DIAGNOSIS(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private DIAGNOSIS(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public Identity<Record, Long> getIdentity() {
        return Keys.IDENTITY_DIAGNOSIS;
    }
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Keys.KEY_DIAGNOSIS_PRIMARY;
    }
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_DIAGNOSIS_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FKPVBP31MCI2NP0JLQ7Q4AMFCXX);
    }
     ...
     */
    @Override
    public DIAGNOSIS as(String alias) {
        return new DIAGNOSIS(alias, this);
    }
     ...
     */
    @Override
    public DIAGNOSIS rename(String name) {
        return new DIAGNOSIS(name, null);
    }
}
