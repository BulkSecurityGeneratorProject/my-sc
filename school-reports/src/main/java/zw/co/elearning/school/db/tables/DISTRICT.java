...
public class DISTRICT extends TableImpl<Record> {

    private static final long serialVersionUID = -1706775794;

    /**
     * The reference instance of <code>school.district</code>
     */
    ...
    /**
     * The column <code>school.district.created_date</code>.
     */
    ...
    /**
     * The column <code>school.district.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.district.last_modified_date</code>.
     */
    ...
    /**
     * The column <code>school.district.name</code>.
     */
    ...
    /**
     * The column <code>school.district.province_id</code>.
     */
    public final TableField<Record, Long> PROVINCE_ID = createField("province_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * Create a <code>school.district</code> table reference
     */
    public DISTRICT() {
        this("district", null);
    }
    ...
    /**
     * Create an aliased <code>school.district</code> table reference
     */
    public DISTRICT(String alias) {
        this(alias, DISTRICT);
    }

    private DISTRICT(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private DISTRICT(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_DISTRICT_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FK276UTU38G5LGQETH6PWFM3RW2);
    }
