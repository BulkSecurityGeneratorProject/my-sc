...
public class TB extends TableImpl<Record> {

    private static final long serialVersionUID = -1826707968;

    /**
     * The reference instance of <code>school.tb</code>
     */
    public static final TB TB = new TB();
    ...
    /**
     * The column <code>school.tb.created_date</code>.
     */
    ...
    /**
     * The column <code>school.tb.last_modified_by</code>.
     */
    ...
    /**
     * The column <code>school.tb.last_modified_date</code>.
     */
    ...
    /**
     * Create an aliased <code>school.tb</code> table reference
     */
    public TB(String alias) {
        this(alias, TB);
    }

    private TB(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private TB(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_TB_PRIMARY);
    }
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FKQ2OOMEOL2DEGTR0XOBSATVXER, Keys.FKG5C9KL8R7RPBMEAHO6M25544L);
    }
     ...
     */
    @Override
    public TB as(String alias) {
        return new TB(alias, this);
    }
     ...
     */
    @Override
    public TB rename(String name) {
        return new TB(name, null);
    }
}
